...
function SectionHeader() {
  ...
  return (
    <div
      className="flex flex-col gap-6 items-center justify-center relative shrink-0 text-center w-full px-6 max-w-4xl mx-auto"
...
function Content() {
  return (
    <div
      className="absolute box-border content-stretch flex items-center justify-between left-0 mask-alpha mask-intersect mask-no-clip mask-no-repeat overflow-clip px-4 sm:px-8 md:px-16 py-6 top-0 w-full"
      data-name="content"
      style={{ maskImage: `url('${imgHeroContent}')` }}
    />
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col h-[900px] items-center justify-start relative shrink-0 w-full overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg, rgba(245,245,247,0.9) 0%, rgba(255,255,255,0.7) 50%, rgba(248,250,252,0.9) 100%)",
...
export default function LandingWeb() {
  ...
  return (
    <div
      className="content-stretch flex flex-col items-center justify-center relative w-full min-h-screen overflow-x-hidden"
      data-name="landing (web)"
    >
      {/* Hero Section */}
      ...
      {/* Location */}
      <section className="w-full py-16 md:py-24" data-name="locations">
        <ElegantLocation />
      </section>
      ...
      <section className="w-full py-16 md:py-24" data-name="contact-us">
        <ElegantWeddingParty />
      </section>
