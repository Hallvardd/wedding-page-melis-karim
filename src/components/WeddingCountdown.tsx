...
export function WeddingCountdown() {
  ...
  const generateCalendarFile = () => {
    const event = {
      ...
      location: 'Siegelsbacher Mühle, Mühlenstraße 15, 74936 Siegelsbach, Deutschland'
    };
      ...
      >
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-6">
          {[0, 0, 0, 0].map((_, index) => (
            ...
            >
              <div className="text-gray-800 text-[32px] sm:text-[40px] font-semibold tracking-[-0.02em] leading-none">0</div>
              <div className="text-gray-700 text-[14px] sm:text-[15px] font-medium mt-2 tracking-[-0.01em]">
                {[t('countdown.days'), t('countdown.hours'), t('countdown.minutes'), t('countdown.seconds')][index]}
              </div>
            </div>
          ))}
        </div>
    ...
    >
      ...
      <div 
        ...
        style={{
          ...
          boxShadow: '0 8px 32px -8px rgba(0, 0, 0, 0.08), 0 0 0 1px rgba(255, 255, 255, 0.5)',
          border: '1px solid rgba(255, 255, 255, 0.8)'
        }}
      >
        {/* Title */}
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          {/* RSVP Button */}
          <a
            href="https://forms.cloud.microsoft/r/dvQD4aJkE4"
            target="_blank"
            ...
            style={{
              ...
              backdropFilter: 'blur(15px)',
              WebkitBackdropFilter: 'blur(15px)',
              boxShadow: '0 4px 12px -2px rgba(0, 0, 0, 0.1), 0 0 0 1px rgba(255, 255, 255, 0.9)',
