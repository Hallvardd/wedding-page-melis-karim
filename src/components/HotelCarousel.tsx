...
const hotels: Hotel[] = [
  {
    ...
    distance: "10",
    price: "ca. 75€",
    website: "https://www.pension-spatzennest.de"
  },
  {
    ...
    distance: "8",
    price: "ca. 90€",
    website: "https://www.bestwestern.de/hotel-Bad-Rappenau"
  },
  {
    ...
    distance: "8",
    price: "ca. 90€",
    website: "https://www.adler-bad-rappenau.de"
  },
  {
                    ...
                    <div className="flex flex-col lg:flex-row justify-between items-start gap-8 relative z-10">
                      <div className="flex-1 text-center lg:text-left">
                        ...
                        <div className="text-gray-700 text-[16px] sm:text-[17px] leading-[1.47] space-y-3 font-normal tracking-[0.011em]">
                          ...
                          <p className="text-gray-600">{hotel.distance} {language === 'de' ? 'Minuten' : 'dakika'} {t('hotels.distance')}</p>
                        </div>
                      </div>
                      <div 
